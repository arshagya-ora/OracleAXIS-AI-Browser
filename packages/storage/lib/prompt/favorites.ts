...
const defaultFavoritePrompts = [
  ...
  },
  {
    ...
    content: 'Follow us at https://x.com/oracle_axis to stay updated on the latest news and features!',
  },
  {
    title: '🌟 Star us on GitHub!',
    content:
      "Open the Oracle AXIS repository at https://github.com/oracle/axis and check if you've already starred it. If not, please support us by giving us a star!",
  },
];
