        ...
        {showHistory ? (
          ...
          <>
            ...
            {hasConfiguredModels === null && (
              <div
                className={`flex flex-1 items-center justify-center p-8 ${isDarkMode ? 'text-warm-gray' : 'text-warm-text'}`}>
                <div className="text-center">
                  <div className="mx-auto mb-4 size-8 animate-spin rounded-full border-2 border-oracle-red border-t-transparent"></div>
            ...
            {hasConfiguredModels === false && (
              <div
                ...
                <div className="max-w-md text-center">
                  <img src="./oracle-logo.svg" alt="Oracle AXIS Logo" className="mx-auto mb-4 size-12" />
                  <h3 className={`mb-2 text-lg font-semibold ${isDarkMode ? 'text-warm-border' : 'text-ebony'}`}>
                    {t('welcome_title')}
                  </h3>
            ...
            {hasConfiguredModels === true && (
              <>
                ...
                {messages.length > 0 && (
                  <div
                    className={`border-t ${isDarkMode ? 'border-ebony-muted' : 'border-warm-border'} p-2 shadow-sm`}>
                    <ChatInput
                      onSendMessage={handleSendMessage}
                      onStopTask={handleStopTask}
